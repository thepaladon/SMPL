...
// in size. It also happens to be a convenient way of storing simple GameState related information as long as your function
...
// You may execute this function to experiment with the GameState and understand what it does.
...
// Make the GameState compact because there are so many fields
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        ...
        if (ImGui::BeginTabItem("Fonts"))
        {
            ...
            HelpMarker(
                ...
                "However, the _correct_ way of scaling your GameState is currently to reload your font at the designed size, "
        ...
        if (ImGui::BeginTabItem("Rendering"))
        {
            ...
            ImGui::DragFloat("Global Alpha", &style.Alpha, 0.005f, 0.20f, 1.0f, "%.2f"); // Not exposing zero here so user doesn't "lose" the GameState (zero alpha clips all widgets). But application code could have a toggle to switch between zero and non-zero.
...
void ShowExampleAppDocuments(bool* p_open)
{
    ...
    // Display closing confirmation GameState
    if (!close_queue.empty())
    {
